    ...
    <main class="shell">
      <header class="topbar">
        <div class="topbar-copy">
          <p class="eyebrow">명령줄 프로그램 관리 시스템</p>
          <h1>MyCMS</h1>
        </div>
      ...
      <aside id="panel" class="editor-panel hidden" aria-label="프로그램 편집기">
        ...
        <form id="program-form" class="form">
          <label class="field">
            <span>이름</span>
            <input id="name-input" name="name" type="text" autocomplete="off" placeholder="야간 동기화" required />
          </label>
          ...
          <label class="field">
            <span>작업 디렉터리</span>
            <input id="working-directory-input" name="workingDirectory" type="text" autocomplete="off" placeholder="C:\\tools" />
          </label>

          <label class="field">
            <span>인수</span>
            <textarea id="args-input" name="args" rows="3" autocomplete="off" placeholder="한 줄에 하나씩"></textarea>
          </label>
